...
public class MarsRoverApiService {
	...
	public MarsRoverApiResponse getRoverData() {
		...
		ResponseEntity<MarsRoverApiResponse> response = rest.getForEntity("https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?sol=2&api_key=" + API_KEY, MarsRoverApiResponse.class);
