...
public class MarsRoverApiService {
	...
	public MarsRoverApiResponse getRoverData(String roverType, Integer marsSol) {
		...
		ResponseEntity<MarsRoverApiResponse> response = rest.getForEntity("https://api.nasa.gov/mars-photos/api/v1/rovers/"+roverType+"/photos?sol="+marsSol+"&api_key=" + API_KEY, MarsRoverApiResponse.class);
